...
export default function ExpensesScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'المصروفات', headerShown: true,  headerTintColor: Colors.primary, headerTitleStyle: { ...Typography.h4, color: Colors.text }, headerTitleAlign: 'center' }} />
